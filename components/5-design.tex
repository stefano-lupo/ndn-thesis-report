...
An alternative design for the interaction API is to have players maintain outstanding Interests for Data packets which represent interactions with their game objects. For example, nodeB could interact with a game object owned by nodeA by satisfying nodeA's outstanding interaction Interest with a Data pakcet which contains the \textit{id} of the game object nodeB wishes to interact with, along with any arbitrary data parameterizing the Interest. 
