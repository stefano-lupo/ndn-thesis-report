...
Another mechanism for determining the entities of interest based on the players view of the game world is Binary Space Partition (BSP), as used in Quak
\begin{figure}[H]
    \centering
