\documentclass[a4paper,oneside,12pt, table, xcdraw]{book}
...
\newcommand{\typeofthesis}{MAI Dissertation} % dissertation, Final Year Project, report, etc.
...
\lstdefinestyle{protoStyle} {
  ...
  breakatwhitespace=true,
  tabsize=1,
  morekeywords={optional, required, message, enum, repeated, GameObject, Status, PlayerStatus, float, bool},
  captionpos=b
}
...
\input{components/-5-title-page.tex}
\input{components/-4-declaration.tex}
\input{components/-3-summary.tex}
\input{components/-2-abstract.tex}
\input{components/-1-acknowledgements.tex}
\input{components/0-preamble.tex}
...
\input{components/6-implementation-frontend.tex}
\input{components/7-implementation-backend.tex}
\input{components/8-implementation-testing.tex}
\input{components/9-evaluation.tex}
\input{components/10-conclusion.tex}
...
\input{components/11-appendix.tex}
